...
/**
 * Contenido de la documentación del sistema. Se muestra dentro de
 * Configuración (y en /documentacion para compatibilidad de links).
 */
...
export default function DocumentacionContent() {
  return (
