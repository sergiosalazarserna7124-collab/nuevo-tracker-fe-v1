...
export const DEFAULT_METRICAS_CONFIG: MetricaConfig[] = [
  ...
  { id: "default-llamadas", nombre: "Llamadas realizadas", tipo: "automatica", ubicacion: "panel_ejecutivo", orden: 3, formato: "numero", color: "cyan", formula: { tipo: "directo", fuente: "callsMade" } },
  { id: "default-contestadas", nombre: "Contestadas", tipo: "automatica", ubicacion: "panel_ejecutivo", orden: 4, formato: "numero", color: "cyan", formula: { tipo: "directo", fuente: "contestadas" } },
  { id: "default-tasa-contestacion", nombre: "Tasa de contestación", tipo: "automatica", ubicacion: "panel_ejecutivo", orden: 5, formato: "porcentaje", color: "cyan", formula: { tipo: "directo", fuente: "answerRate" } },
  // --- Bloque 2: Velocidad y esfuerzo ---
  { id: "default-speed", nombre: "Speed to lead general", tipo: "automatica", ubicacion: "panel_ejecutivo", orden: 6, formato: "tiempo", color: "purple", formula: { tipo: "directo", fuente: "speedToLeadAvg" }, descripcion: "Minutos promedio desde que se creó el lead hasta la primera llamada (sin importar horario ni zona)." },
  { id: "default-speed-asesor", nombre: "Speed to lead asesor", tipo: "automatica", ubicacion: "panel_ejecutivo", orden: 7, formato: "tiempo", color: "cyan", formula: { tipo: "directo", fuente: "speedToLeadAsesor" }, descripcion: "Minutos promedio EN HORARIO LABORAL desde que se asignó el lead al asesor hasta la primera llamada." },
  { id: "default-intentos", nombre: "Intentos promedio", tipo: "automatica", ubicacion: "panel_ejecutivo", orden: 8, formato: "decimal", color: "amber", formula: { tipo: "directo", fuente: "avgAttempts" }, descripcion: "Llamadas realizadas ÷ Leads del período (50 leads y 75 llamadas → 1.5)" },
  // --- Bloque 3: Pipeline de citas ---
  { id: "default-agendadas", nombre: "Citas agendadas", tipo: "automatica", ubicacion: "panel_ejecutivo", orden: 9, formato: "numero", color: "purple", formula: { tipo: "directo", fuente: "meetingsBooked" } },
  { id: "default-asistidas", nombre: "Citas asistidas", tipo: "automatica", ubicacion: "panel_ejecutivo", orden: 10, formato: "numero", color: "green", formula: { tipo: "directo", fuente: "meetingsAttended" }, descripcion: "Leads que asistieron a la cita (con interacción real: grabación/transcript)" },
  { id: "default-tasa-agendamiento", nombre: "Tasa de agendamiento", tipo: "automatica", ubicacion: "panel_ejecutivo", orden: 11, formato: "porcentaje", color: "purple", formula: { tipo: "directo", fuente: "tasaAgendamiento" }, descripcion: "Leads que agendaron ÷ Leads que contestaron" },
  { id: "default-tasa-asistencia", nombre: "Tasa de asistencia", tipo: "automatica", ubicacion: "panel_ejecutivo", orden: 12, formato: "porcentaje", color: "cyan", formula: { tipo: "directo", fuente: "tasaAsistencia" }, descripcion: "Asistidas ÷ (Agendadas − Pendientes − Canceladas). Ej: 13 agendadas, 1 cancelada, 2 pendientes, 8 asistidas → 80%" },
  { id: "default-no-shows", nombre: "No shows", tipo: "automatica", ubicacion: "panel_ejecutivo", orden: 13, formato: "numero", color: "amber", formula: { tipo: "directo", fuente: "noShows" }, descripcion: "Personas que no se presentaron" },
  { id: "default-canceladas", nombre: "Canceladas", tipo: "automatica", ubicacion: "panel_ejecutivo", orden: 14, formato: "numero", color: "red", formula: { tipo: "directo", fuente: "meetingsCanceled" }, descripcion: "Citas canceladas por el lead" },
  { id: "default-pendientes-agendas", nombre: "Citas pendientes", tipo: "automatica", ubicacion: "panel_ejecutivo", orden: 15, formato: "numero", color: "blue", formula: { tipo: "directo", fuente: "pendientesAgendas" }, descripcion: "Citas agendadas sin resultado aún: la reunión no ha ocurrido, o pasó y espera clasificación (Fathom o el barrido de no-shows)" },
  // --- Bloque 4: Cierre ---
  { id: "default-tasa-cierre", nombre: "Tasa de cierre", tipo: "automatica", ubicacion: "panel_ejecutivo", orden: 16, formato: "porcentaje", color: "green", formula: { tipo: "directo", fuente: "tasaCierre" }, descripcion: "Ventas (etiqueta compro) ÷ Citas asistidas" },
  // --- Bloque 5: Dinero ---
  ...
  { id: "default-apartados", nombre: "Apartados", tipo: "automatica", ubicacion: "panel_ejecutivo", orden: 17, formato: "numero", color: "cyan", formula: { tipo: "directo", fuente: "apartados" }, descripcion: "Leads con etiqueta 'apartado' (cuenta por oportunidad)" },
  { id: "default-monto-apartado", nombre: "Monto apartado", tipo: "automatica", ubicacion: "panel_ejecutivo", orden: 18, formato: "moneda", color: "cyan", formula: { tipo: "directo", fuente: "montoApartado" }, descripcion: "Suma del campo 'Monto de apartado' de las oportunidades apartadas" },
  { id: "default-ventas", nombre: "Ventas", tipo: "automatica", ubicacion: "panel_ejecutivo", orden: 19, formato: "numero", color: "green", formula: { tipo: "directo", fuente: "ventas" }, descripcion: "Leads con etiqueta 'compro' (cuenta por oportunidad)" },
  { id: "default-monto-vendido", nombre: "Monto vendido", tipo: "automatica", ubicacion: "panel_ejecutivo", orden: 20, formato: "moneda", color: "green", formula: { tipo: "directo", fuente: "montoVendido" }, descripcion: "Suma del value de las oportunidades con etiqueta 'compro'" },
  ...
  { id: "default-ticket", nombre: "Ticket promedio", tipo: "automatica", ubicacion: "panel_ejecutivo", orden: 21, formato: "moneda", color: "blue", formula: { tipo: "directo", fuente: "avgTicket" }, descripcion: "Monto vendido ÷ Ventas (5 ventas de $500.000 en total → $100.000)" },
  // --- Bloque 6: Calidad de leads ---
  { id: "default-descartados", nombre: "Leads descartados", tipo: "automatica", ubicacion: "panel_ejecutivo", orden: 22, formato: "numero", color: "red", formula: { tipo: "directo", fuente: "leadsDescartados" }, descripcion: "Leads marcados como descartados (etiqueta descartar-lead o descarte manual). No cuentan en las métricas globales, pero quedan visibles aquí." },
];
